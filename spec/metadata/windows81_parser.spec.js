...
describe('windows81 project parser', function() {
    ...
    describe('constructions', function() {
        it('should throw if provided directory does not contain a jsproj file', function() {
            readdir.andReturn([]);
            expect(function() {
                new platforms.windows81.parser(proj);
        ...
        it('should create an instance with path, manifest properties', function() {
            expect(function() {
                var p = new platforms.windows81.parser(proj);
                expect(p.windows81_proj_dir).toEqual(proj);
    ...
    describe('check_requirements', function() {
        it('should fire a callback if there is an error during shelling out', function(done) {
            ...
            platforms.windows81.parser.check_requirements(proj, function(err) {
        ...
        it('should check by calling check_reqs on a custom path if it is so defined', function(done) {
            var custom_path = path.join('some','custom','path','to','windows81','lib');
    ...
    describe('instance', function() {
        ...
        var windows81_proj = path.join(proj, 'platforms', 'windows81');
        beforeEach(function() {
            p = new platforms.windows81.parser(windows81_proj);
            cp = spyOn(shell, 'cp');
            rm = spyOn(shell, 'rm');
            mv = spyOn(shell, 'mv');
        ...
        describe('www_dir method', function() {
            it('should return www', function() {
                expect(p.www_dir()).toEqual(path.join(windows81_proj, 'www'));
            });
        });
        describe('staging_dir method', function() {
            it('should return .staging/www', function() {
                expect(p.staging_dir()).toEqual(path.join(windows81_proj, '.staging', 'www'));
            });
        });
